    ...
    for line in lines:
        ...
        if starts_with_timestamp(line):
            ...
            if match:
                ...
                if "Abdullah Chaudhry" in current_sender:
...
def main():
    ...
    INPUT_FILE_PATH = '/Users/umer/Desktop/a .nosync/personal projects/psarag/whatsapp/data/whatsapp_psa_newstudents_winter2425_11oct.txt'
    OUTPUT_FILE_PATH = '/Users/umer/Desktop/a .nosync/personal projects/psarag/whatsapp/data/garbage/whatsapp_psa_newstudents_winter2425_11oct.txt'
    
    # Read the chat log
    chat_log = read_chat_log(INPUT_FILE_PATH)
    
    # Extract messages with unique IDs
    messages_with_ids = extract_messages_with_ids(chat_log, hide_sender_names=False)
    
    write_messages_to_file(OUTPUT_FILE_PATH, messages_with_ids)
